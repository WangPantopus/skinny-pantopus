...
async function deliverStoredGigNotification(notification, { pushAllowedAtCapture } = {}) {
  if (!notification?.id || !['bid_accepted', 'bid_on_standby', 'payout_onboarding_nudge', 'payout_sent', 'payment_completed', 'gig_auto_cancelled', 'payment_auth_expiring', 'gig_cancelled', 'bid_reopened', 'bid_rejected', 'worker_cant_make_it', 'tip_received', 'gig_confirmed'].includes(notification.type)) {
