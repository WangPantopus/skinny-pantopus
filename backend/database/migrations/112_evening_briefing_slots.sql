-- ============================================================
-- 112: Add evening briefing preferences and delivery slots
-- Enables a separate evening briefing preference and makes
-- DailyBriefingDelivery idempotent per (user, local date, slot).
-- ============================================================
