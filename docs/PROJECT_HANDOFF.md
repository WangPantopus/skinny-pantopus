...
**Active native candidate — PR #35:** both installed own-review history readers and the separate fresh iOS cycle pass. See [native WIP and exact CI limits](home-native-history-wip-2026-09-13.md) on the native branch and [iOS evidence](https://github.com/WangPantopus/skinny-pantopus/blob/codex/home-residency-review-history/docs/home-ios-residency-review-history-2026-09-13.md). Primary remains `f14989637`; native history is not integrated. The fresh iOS fixture is exactly cleaned and its simulator is stopped with data retained. Root now owns emulator-5556/API18084/REST18086 for the fresh Android cycle. Finish that cycle before integration, then current-claims privacy and the ordered backlog. All four PRs #32/#34/#35/#36 remain drafts; 8/80 acceptance rows are closed.
