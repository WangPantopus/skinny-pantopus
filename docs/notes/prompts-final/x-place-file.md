...
ATTACH: the current Place tab root on web 1440 (with the app sidebar and the Place nav rail: Overview, Risk & readiness, Civic and the rest), web 390, iOS and Android; the current Today tab on iOS (so the band's 14-day window matches the FourteenDayStrip geometry); exports of the Foundations boards 00a–00d.
...
- "Tell your landlord in writing by Mon 1 Mar 2027" · "in 4 months · Mon 1 Mar 2027" · "One time" · "Reminders Sat 30 Jan, Sun 28 Feb and Mon 1 Mar" · "From your lease: 30 days' notice" · Household.
...
7. x-place-file · ios · 07-reminder-landing · light — as of Sat 30 Jan 2027, 7:00 AM: band Feb 2027–Jan 2028, notice row highlighted with focus; a margin note shows the deleted-date landing with "That date was removed" at the top of Dates.
