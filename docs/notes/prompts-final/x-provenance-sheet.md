...
ATTACH: screenshots of the Foundations boards 00a–00d; the Today tab with its pickup card, 14-day strip and air band; the Place tab risk details with its scale strips; the compare reveal (Dana's card) on web-390; the seasonal aha card; and the DateSheet. These are the backdrops the sheet opens over.
...
- P3, you added (lease), tick mark. Value "Lease ends Wed 31 Mar 2027" with caption "in 163 days". Detail "Tell your landlord in writing by Mon 1 Mar 2027 · in 133 days" and "Reminder Sat 30 Jan 2027". Source "You". Updated "Added Mon 14 Sep 2026". Covers "Your household".
