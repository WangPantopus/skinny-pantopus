...
- R4 · Dates: Lease ends Wed 31 Mar 2027; Notice deadline Mon 1 Mar 2027; reminder Sat 30 Jan 2027.
...
- H22 · The lease reminder (R4) must reach this iPhone on Sat 30 Jan 2027 at 7:00 AM, although the morning briefing is off, and it must land on the place file's Dates row (x-place-file 07), because Mon 1 Mar 2027 is outside Today's 14-day window. Status: open.
