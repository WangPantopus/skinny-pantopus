...
ATTACH: (1) the current Home settings screen for HOME A on iOS, Android, web 1440 and web 390; (2) exports of the Foundations boards 00a–00d (FactRow, DateSheet, InlineUndo, InlineErrorRow, LockedActionRow, ProvenanceMark, ScopeChip, OfflineNotice, FreshnessLine); (3) the place file's Moved in row and its hidden-checklist line, for the arrival frame.
