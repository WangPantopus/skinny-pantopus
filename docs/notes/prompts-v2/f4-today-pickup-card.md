...
ATTACH: Today on iOS 393, Android 412, web 390 and web 1440, showing the location row, the 14-day strip card and the briefing card, in both the "Your household" and the "Saved place · Only you" versions. Also attach the Foundations board from prompt 00.
