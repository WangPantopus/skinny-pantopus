...
- Lease ends · "in 163 days · Wed 31 Mar 2027". Caption: "Notice due Mon 1 Mar 2027 · reminder Mon 15 Feb 2027". Scope pair: Only you → household (pending). The linked Notice deadline row moves with its lease row and is shown as this caption; it is not counted as a separate date.
