...
Updated September 12, 2026 after ordinary-member Task acceptance.
...
Verify the bounded H07/H08 milestone's integration commit/push and exact-head CI,
then older-client residency compatibility (R02) and the full ordered backlog.
...
- [ ] G03 **Integrate:** Reconcile the primary source’s 46 Home / 21 payment / 55 distinct combined migration versions and dependency order (12 byte-identical shared versions, zero collisions at this checkpoint). The source includes Task default version `20260912050000`; isolated R02 version `20260912060000` is not included yet. The reserved tip migration is not yet implemented and will change the final set.
...
Next: accept and integrate isolated R02 legacy submission compatibility while
verifying the Task milestone’s actual committed/pushed head and exact-head CI. Refresh current Git/PR checks and fixture ownership
