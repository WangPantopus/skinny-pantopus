...
- [ ] P06 **Fix/Verify:** Finish disputes and dispute-loss accounting, historical Connect transfers/reversals, payout onboarding/withdrawal and operational debt recovery, including contradictory legacy proof. September22: PR184 adds bounded real Stripe TEST evidence drafts (including the automatic caller), read failure/retry, duplicate events and untransferred won/lost closure reflected in real web/API/SQL. Both fixture families cleaned. PR185 adds won-dispute wallet eligibility/admin detection; PR187 adds actual TEST lost-after-wallet-income recovery, real web zero/adjustment, failure/retry and rollback SQL debt/proof controls. Both pass full CI and exact cleanup. Native dispute, hosted operational debt management, historical Connect transfers/reversals/live and hosted delivery remain open. See current Stream1 evidence.
