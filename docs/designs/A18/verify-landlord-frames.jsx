...
// Two frames: populated (just submitted) + secondary (landlord confirmed, final review)
...
function TopBarVL({ kind = 'close', title }) {
  return (
    <div style={{
...
function HaloCircleVL({ kind = 'success', icon }) {
  const map = {
...
function StickyDockVL({ primary, secondary, icon }) {
  return (
    <div style={{
...
function FrameVerifyLandlordSubmitted() {
  return (
    <PhoneVL>
      <TopBarVL kind="close" title="Verification submitted"/>
      ...
      <div style={{
        ...
        <HaloCircleVL kind="success" icon="check"/>

        <div>
          <h2 style={{
            margin:0, fontSize:24, fontWeight:700, color:ST.fg1,
            letterSpacing:-0.4, lineHeight:'29px',
          }}>Verification submitted</h2>
          <p style={{
            margin:'10px 0 0', fontSize:14, color:ST.fg2,
            lineHeight:'20px', maxWidth:290, letterSpacing:-0.05,
          }}>
            We emailed your landlord at <strong style={{color:ST.fg1, fontWeight:700}}>r.osman@acme-realty.com</strong> to confirm. You'll get a push when they do.
          </p>
        </div>
        ...
        <div style={{
          ...
          <TimelineVL steps={[
            {label:'Lease + ID',           state:'done', sub:'Oct 10'},
            {label:'Landlord confirms',    state:'pending'},
        ...
        <div style={{
          ...
          Most landlords confirm in 1–2 days
        </div>
      </div>

      <StickyDockVL primary="Back to home" secondary="View status" icon="home"/>
    </PhoneVL>
  );
}

// ─── FRAME B · SECONDARY — landlord confirmed, final review ───
function FrameVerifyLandlordConfirmed() {
  return (
    <PhoneVL>
      <TopBarVL kind="close" title="Verification submitted"/>
      ...
      <div style={{
        ...
        <HaloCircleVL kind="success" icon="user-check"/>

        <div>
          <h2 style={{
            margin:0, fontSize:24, fontWeight:700, color:ST.fg1,
            letterSpacing:-0.4, lineHeight:'29px',
          }}>Landlord confirmed</h2>
          <p style={{
            margin:'10px 0 0', fontSize:14, color:ST.fg2,
            lineHeight:'20px', maxWidth:290, letterSpacing:-0.05,
          }}>
            <strong style={{color:ST.fg1, fontWeight:700}}>Rashida Osman</strong> confirmed your tenancy. Pantopus is doing a final review before your Resident badge goes live.
          </p>
        </div>
        ...
        <div style={{
          ...
          <TimelineVL steps={[
            {label:'Lease + ID',         state:'done',    sub:'Oct 10'},
            {label:'Landlord confirms',  state:'done',    sub:'Oct 11'},
            {label:'Verified',           state:'current', sub:'In review'},
          ]}/>
        </div>
...
Object.assign(window, { FrameVerifyLandlordSubmitted, FrameVerifyLandlordConfirmed });
