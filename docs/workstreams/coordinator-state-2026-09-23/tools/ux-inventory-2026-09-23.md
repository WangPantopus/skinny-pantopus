...
This is the existing 155-item UX inventory, not a whole-app E2E coverage measure. Recounting the final handoff's explicit IDs gives29 unpublished and62 not-started items (its summary said31/about60). PR389 is now merged, moving S1-21 from open to fixed/merged. Batch4/#394 also merged C-15/#356; verified at2026-09-23T23:50:35Z. Batch5/#398 also merged C-21/C-37 through#395; verified at2026-09-24T01:02:09Z. Batch7/#404 then closed C-29/C-33, and batch8/#410 closed S1-05,S1-04,S1-20(native),S1-17(iOS),S2-14. Current planning disposition at the September24 pause: **73 fixed/merged,20 in flight,62 not started;82 unfinished**. The fixed/merged category preserves prior accepted evidence and does not assert a fresh all-platform pass. Newly discovered work such as geo392 is recorded in the hub without silently changing this inventory denominator. Original findings below remain historical until their owners reconcile each item with accepted evidence.


September24 resume update08:34Z: batch9/#419 merged exact reviewed397/409/412–416. Close C-08/C-09/C-16 and S1-03/10/11/12/14/15/16/18/23 (12 unique; C-07 previously counted, S1-12 two halves count once). **85 original items merged;70 unfinished.** In-flight versus not-started is being reconciled as resumed work advances; do not reuse the paused20/62 split as current. See hub current resume and `coordinator-state-2026-09-24/batch9-merged.json` for Git ancestry and real-app limits. New discoveries remain outside155.
