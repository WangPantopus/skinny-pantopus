...
T1="2026-09-23 01:37:00+00"
SYN="'14483c00-27ec-4e32-bead-57aee1a9ba18'"
HOME="'f0e51100-0000-4000-8000-000000000200'"
$P -qAt > $W/cleanup-ids-hub.json <<SQL
...
SQL
python3 -c "import json;d=json.load(open('$W/cleanup-ids-hub.json'));print({k:len(v) for k,v in d.items()})"
