...
**Relationship:** Addendum to the [nationwide product design](https://github.com/WangPantopus/skinny-pantopus/blob/6664315bb6d9e0036723f79bad8c9e3b1202ff05/docs/pantopus-nationwide-product-design-2026-09-08.md), preserved on `improve-product-feature` at the linked commit and absent from this master checkout. Existing Home, Pulse/Feed, Beacon, Marketplace, Gigs, chat, property intelligence, weather, air quality, elections, waste/recycling, and other utilities remain in scope.
