...
DO $$ DECLARE t record; BEGIN
  ASSERT to_regclass('public."HomePostcardRequestCommand"') IS NULL AND to_regclass('public."HomePostcardVerificationCommand"') IS NULL;
...
WHERE n.nspname='public' AND p.proname IN('lock_home_postcard_current_scope','home_postcard_current_context','get_home_postcard_request','cancel_home_postcard_request','begin_home_postcard_request','home_postcard_confirmed_address','get_home_postcard_current_status','claim_home_postcard_current_dispatch','record_home_postcard_current_dispatch','get_home_postcard_verification','cancel_home_postcard_verification','home_postcard_verified_policy','verify_home_postcard_current','promote_home_postcard_review','challenge_home_postcard_review','review_home_residency');
