...
DO $$ BEGIN
  IF (SELECT count(*) FROM public."HomeRolePermission") <> 31 THEN
...
BEGIN
  ...
  END IF;
  IF public.home_get_user_permissions(h, 'ddb00000-0000-4000-8000-000000000012') IS DISTINCT FROM ARRAY['home.view','tasks.edit','tasks.view']::text[] THEN
    RAISE EXCEPTION 'Member must receive exactly the explicit overview and Task defaults';
  END IF;
