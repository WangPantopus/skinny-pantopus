...
@Singleton
open class HomeTaskMediaRepository @Inject constructor(private val api: HomeTaskMediaApi) {
    open suspend fun list(session: HomeTaskSessionDto, taskId: String) =
    ...
    open suspend fun upload(
        ...
        return safeApiCall {
            api.upload(
                session.homeId, taskId, session.sessionScope,
    ...
    open suspend fun download(session: HomeTaskSessionDto, taskId: String, mediaId: String) = safeApiCall {
    ...
    open suspend fun remove(session: HomeTaskSessionDto, taskId: String, mediaId: String) =
