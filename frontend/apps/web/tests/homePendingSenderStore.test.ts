import { PendingSenderStore } from '../src/components/home/invitations/PendingSenderStore';
...
test.each([null, false, 0, ''])('present malformed recovery value %p is kept and cannot look empty', async value => {
  ...
  const store = new PendingSenderStore('http://127.0.0.1:18080', '10000000-0000-4000-8000-000000000001');
