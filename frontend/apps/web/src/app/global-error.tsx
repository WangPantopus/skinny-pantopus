...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-app flex items-center justify-center p-6">
        <div className="w-full max-w-lg rounded-xl border border-app bg-surface p-6 text-center">
          <h1 className="text-lg font-semibold text-app mb-2">App failed to load</h1>
          <p className="text-sm text-app-secondary mb-5">
            This is usually recoverable. Try reload first. If it persists, clear app cache and reload.
          </p>
