...
import type { HomeTask } from '@/components/home/tasks/homeTaskModel';
...
function TasksContent() {
  ...
  const recurringTasks = tasks.filter(task => !!task.recurrence_rule);
              ...
              <div key={task.id} className="flex items-start gap-3 bg-app-surface border border-app-border rounded-xl p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1.5">
                    ...
                    {task.recurrence_rule && <Repeat className="w-3 h-3 text-app-text-secondary" />}
                  </div>
                </div>
