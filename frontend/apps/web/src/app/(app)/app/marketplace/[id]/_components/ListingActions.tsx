  ...
  return (
    <div className="bg-app-surface rounded-xl border border-app-border p-4 mb-6">
      <div className="flex flex-wrap gap-2">
        ...
        {/* View Offers badge (owner): the seller's offers page (accept, decline, counter). */}
        {isOwner && activeOfferCount != null && activeOfferCount > 0 && (
          <button
            onClick={() => router.push(`/app/listing-offers?${new URLSearchParams({ listingId, title: listing.title || 'Listing' })}`)}
