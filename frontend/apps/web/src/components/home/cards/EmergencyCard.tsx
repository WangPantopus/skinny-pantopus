            ...
            contacts.map((c) => {
              ...
              <div key={c.id} className="px-4 py-3 flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {c.location && <div className="text-xs text-app-text-secondary mt-0.5">{c.location}</div>}
                  {phone && (
            ...
            <div className="px-4 py-3 space-y-2">
              {plans.map((p) => {
                ...
                <div key={p.id}>
                  ...
                  {p.location && <div className="text-xs text-app-text-secondary mt-1">{p.location}</div>}
          ...
          <div className="bg-app-surface rounded-xl border border-app-border shadow-sm divide-y divide-app-border-subtle">
            {other.map((item) => {
              ...
              <div key={item.id} className="px-4 py-3">
                ...
                {item.location && <div className="text-xs text-app-text-secondary mt-0.5">{item.location}</div>}
                {notes && <div className="text-xs text-app-text-muted mt-0.5">{notes}</div>}
              </div>
              );
            })}
