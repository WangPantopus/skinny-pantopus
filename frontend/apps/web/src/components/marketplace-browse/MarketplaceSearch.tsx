...
export default function MarketplaceSearch({
  ...
  function getCategoryIcon(catName: string) {
    ...
    if (match) return <CategoryIcon name={match.emoji} className="w-4 h-4 text-app-link" />;
    return (
      <svg className="w-4 h-4 shrink-0 text-app-link" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
