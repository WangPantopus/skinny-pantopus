...
//  discovery controls, and tab bar — so this view reuses `FeedView` with a `.beacons`
//  `PulseFeedViewModel`. Only the title, credential presentation, and empty state
...
/// `surface=personas` query, the public-profile credentials, and the
