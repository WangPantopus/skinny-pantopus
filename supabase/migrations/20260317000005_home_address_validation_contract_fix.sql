-- Migration: Align HomeAddress validation enums and granularity column
--
...
BEGIN
  IF EXISTS (
    ...
    ';
    EXECUTE 'ALTER TABLE "public"."HomeAddress" DROP COLUMN "google_granularity"';
  END IF;
END $$;
