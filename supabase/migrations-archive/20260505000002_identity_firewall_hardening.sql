...
--
-- This migration is intentionally additive because
-- 20260505000001_identity_firewall_personas.sql may already be applied in
-- existing environments. Keep this file idempotent so it can safely repair
-- databases that ran an earlier draft of the Identity Firewall migration.
