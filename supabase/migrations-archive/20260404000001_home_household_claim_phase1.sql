-- Migration: Home household claim Phase 1
--
-- Phase 1 is additive schema + compatibility backfill only.
-- This migration must not change route behavior or enable parallel claims.
